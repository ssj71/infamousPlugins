...
inline int cairo_code_draw_blueLED_get_width() { return 19; }
inline int cairo_code_draw_blueLED_get_height() { return 19; }
...
pattern = cairo_pattern_create_rgba(0,0.133333,0.333333,1);
...
cairo_pattern_add_color_stop_rgba(pattern, 0,0,0,1,1);
cairo_pattern_add_color_stop_rgba(pattern, 0,0,0,1,1);
cairo_pattern_add_color_stop_rgba(pattern, 0,0,0,1,0.4);
