...
static int cairo_code_draw_vintagedial_get_width() { return 91; }
static int cairo_code_draw_vintagedial_get_height() { return 91; }
static void cairo_code_draw_vintagedial_render(cairo_t *cr, float val) {
